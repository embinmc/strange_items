...
public class LegacyTracker {
    ...
    public LegacyTracker(String id, TagKey<Item> tag, StatFormatter stat_formatter, int formatted_value_multiplier) {
        this.stat_formatter = stat_formatter;
        this.formatted_value_multiplier = formatted_value_multiplier;
        this.item_tag = tag;
        this.id = Id.of(id).toString();
    }
    public LegacyTracker(String id, TagKey<Item> tag) {
        this.item_tag = tag;
        this.id = Id.of(id).toString();
    }
