...
public class TrackerDataProvider extends FabricDynamicRegistryProvider {
    ...
    private static void basic(BootstrapContext<Tracker> context, ResourceKey<Tracker> key, Trigger trigger, StatFormatter statFormatter, TagKey<Item> itemTag) {
    ...
    private static void basic(BootstrapContext<Tracker> context, ResourceKey<Tracker> key, Trigger trigger, Item item) {
        Identifier trackerId = key.identifier();
        context.register(key, new BasicTracker(
                        trigger,
                        Component.translatable("tracker." + trackerId.getNamespace() + "." + trackerId.getPath()
    ...
    private static void basic(BootstrapContext<Tracker> context, ResourceKey<Tracker> key, Trigger trigger, TagKey<Item> itemTag) {
        basic(context, key, trigger, StatFormatters.DEFAULT, itemTag);
    }

    private static void timestamp(BootstrapContext<Tracker> context, ResourceKey<Tracker> key, Trigger trigger, TagKey<Item> itemTag) {
        HolderGetter<Item> items = context.lookup(Registries.ITEM);
        Identifier trackerId = key.identifier();
    ...
    private static void idMap(BootstrapContext<Tracker> context, ResourceKey<Tracker> key, Trigger trigger, StatFormatter statFormatter, TagKey<Item> itemTag, String translationPrefix) {
        HolderGetter<Item> items = context.lookup(Registries.ITEM);
        Identifier trackerId = key.identifier();
    ...
    private static void idMap(BootstrapContext<Tracker> context, ResourceKey<Tracker> key, Trigger trigger, StatFormatter statFormatter, TagKey<Item> itemTag) {
        HolderGetter<Item> items = context.lookup(Registries.ITEM);
        Identifier trackerId = key.identifier();
        context.register(key, new IdMapTracker(
                        trigger,
    ...
    public static void bootstrap(BootstrapContext<Tracker> c) {
        ...
        idMap(c, Trackers.BLOCKS_MINED, Trigger.BLOCK_MINED, StatFormatters.DEFAULT, TrackerItemTags.TRACKER_BLOCKS_MINED, "block");
        ...
        basic(c, Trackers.PLANTS_TRIMMED, Trigger.TRIM_PLANT, TrackerItemTags.TRACKER_SHEARS);
        basic(c, Trackers.SHOTS_FIRED, Trigger.SHOOT_ARROW, TrackerItemTags.TRACKER_BOW);
        idMap(c, Trackers.SHOTS_HIT, Trigger.ARROW_HIT_MOB, StatFormatters.DEFAULT, TrackerItemTags.TRACKER_BOW, "entity");
        basic(c, Trackers.DAMAGE_DEALT, Trigger.DEAL_DAMAGE, StatFormatters.DIVIDE_BY_TEN, TrackerItemTags.TRACKER_WEAPON);
        basic(c, Trackers.TRIDENT_THROWN, Trigger.THROW_TRIDENT, Items.TRIDENT);
        basic(c, Trackers.BLOCKS_BRUSHED, Trigger.ATTEMPT_BRUSH_BLOCK, TrackerItemTags.TRACKER_BRUSH);
        basic(c, Trackers.ARMADILLOS_BRUSHED, Trigger.BRUSH_ARMADILLO, TrackerItemTags.TRACKER_BRUSH);
        idMap(c, Trackers.MOBS_KILLED, Trigger.KILL_MOB, StatFormatters.DEFAULT, TrackerItemTags.TRACKER_MOBS_KILLED, "entity");
        basic(c, Trackers.FISH_CAUGHT, Trigger.CATCH_FISH_WITH_FISHING_ROD, TrackerItemTags.TRACKER_FISHING_ROD);
        idMap(c, Trackers.DAMAGE_TAKEN, Trigger.TAKE_DAMAGE, StatFormatters.DIVIDE_BY_TEN, TrackerItemTags.TRACKER_ARMOR);
        basic(c, Trackers.TIMES_EQUIPPED, Trigger.EQUIP_ITEM, TrackerItemTags.TRACKER_EQUIPPABLE);
        basic(c, Trackers.TIMES_FISHING_ROD_REELED_IN, Trigger.REEL_IN_FISHING_ROD, TrackerItemTags.TRACKER_FISHING_ROD);
        basic(c, Trackers.TIMES_FISHING_ROD_CAST, Trigger.CAST_FISHING_ROD, TrackerItemTags.TRACKER_FISHING_ROD);
        idMap(c, Trackers.TIMES_FISHING_ROD_CAUGHT_SOMETHING, Trigger.CATCH_ITEM_WITH_FISHING_ROD, StatFormatters.DEFAULT, TrackerItemTags.TRACKER_FISHING_ROD);
        ...
        basic(c, Trackers.PUMPKINS_CARVED, Trigger.CARVE_PUMPKIN, TrackerItemTags.TRACKER_SHEARS);
        idMap(c, Trackers.ITEMS_RECOVERED_WITH_BRUSH, Trigger.BRUSH_BLOCK_SUCCEEDS, StatFormatters.DEFAULT, TrackerItemTags.TRACKER_BRUSH, "item");
    }
}
