...
public class StrangeOptions {
    private static final OptionInstance<Integer> MAP_ELEMEMT_LIMIT = new OptionInstance<>(
            ...
            (caption, value) -> {
                ...
                Component valStr = (value >= 51 ? Component.translatable(key) : Component.literal(String.valueOf(value))).withStyle(ChatFormatting.YELLOW);
                return caption.copy().append(": ").append(valStr);
            },
            new OptionInstance.IntRange(3, 51, true), 8, num -> {}
    );
